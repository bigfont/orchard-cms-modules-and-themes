...
namespace BigFont.ContactUs.Models
{
    public class BigFontContactUsRecord : ContentPartRecord
    {
    ...
    public class BigFontContactUsPart : ContentPart<BigFontContactUsRecord>
    {
        [Required]        
